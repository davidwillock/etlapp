...
public class jFundsParameterizedRowMapper implements ParameterizedRowMapper<jPerformanceData>
{
	public jPerformanceData mapRow(ResultSet rs, int rowNum) throws SQLException {
